...
Please find supporting documentation attached. I appreciate your cooperation in resolving this matter."""
    ...
    "Account was settled but shows as charged-off": {
        "subject": "Re: Dispute Regarding Settled Account Incorrectly Marked as Charged-Off",
        "body": """I am disputing the current status of this account, which inaccurately reports as charged-off despite being settled. I negotiated and completed a settlement agreement with the creditor, and as such, the status should reflect 'settled' rather than 'charged-off.'
...
Documentation is enclosed. Please provide written confirmation of the resolution."""
    ...
    "Duplicate account on report": {
        "subject": "Re: Dispute of Duplicate Account Entry on Credit Report",
        "body": """I am writing to dispute a duplicate entry of the same account on my credit report. This account is listed more than once with identical or nearly identical details, which falsely inflates my total number of accounts and skews my credit standing.
...
Supporting information is provided for your investigation."""
    ...
    "Account included in bankruptcy": {
        "subject": "Re: Dispute of Bankruptcy-Related Account Reporting",
        "body": """I am disputing the status of this account, which was legally discharged as part of my bankruptcy filing but is still being reported as active or delinquent. This reporting is inaccurate and violates my rights under federal bankruptcy law and credit reporting regulations.
...
Please delete this account and confirm the action in writing."""
    ...
    "I was not an authorized user": {
        "subject": "Re: Dispute – Inaccurate Authorized User Status",
        "body": """I am disputing an account that inaccurately reports me as an authorized user. I was never added to this account by the primary account holder, nor have I had any involvement with this tradeline.
...
Please complete your investigation and confirm the outcome in writing."""
    ...
    "Incorrect payment history": {
        "subject": "Re: Request for Correction of Inaccurate Payment History",
        "body": """I am disputing inaccuracies in the payment history reported for the account referenced above. The payment timeline contains errors that misrepresent my record and do not reflect the actual activity associated with this account.
...
Attached is supporting information. Please confirm any updates in writing."""
    ...
    "Account already paid or settled": {
        "subject": "Re: Dispute of Account Reported as Unpaid Despite Settlement",
        "body": """I am writing to dispute the reporting of an account that has already been fully paid or legally settled. Despite this, the account continues to reflect as open, past due, or delinquent, which is both inaccurate and harmful to my credit profile.
...
Documentation supporting this payment or settlement is enclosed."""
    ...
    "Wrong account status reported": {
        "subject": "Re: Correction Request for Wrong Account Status",
        "body": """I am disputing the status code currently associated with this account. It reflects a derogatory condition such as '120 days late' or 'charged-off' when this does not match my actual account history or any valid payment record.
...
I have included supporting documentation and look forward to your written confirmation of the update."""
    ...
    "Outdated account info (older than 7-10 years)": {
        "subject": "Re: Request for Removal of Outdated Account Information",
        "body": """I am requesting the removal of the referenced account based on its age. This negative item has exceeded the legal reporting limits under federal law and should no longer appear on my credit report.
...
Please verify the age of the account and remove it accordingly. I appreciate your compliance with federal regulations."""
    ...
    "Charge-off account still updating monthly": {
        "subject": "Re: Illegal Re-aging of Charged-Off Account",
        "body": """I am disputing the ongoing monthly updates to a charged-off account on my credit report. Once an account is charged off, it should not continue reporting new activity unless payments are being made. These updates may constitute re-aging, which is prohibited.
